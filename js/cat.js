...
coolfacts = ["Did you know that the biggest garment-producer in Bangladesh(where H&M makes their clothes)in April 2013 suffered a factory collapse that killed 1,100 people and injured 2,500. While it  drew attention in the media, it did not change  the devastating conditions of clothes manufacturing in the country.",
 ...
 " In 2014 activists rallied against Ralph Lauren for its staunch refusal to sign an international agreement that seeks to improve conditions for factory workers in Bangladesh, one of the world’s biggest clothing suppliers.", 
 ...
 "Mac’s website claims that even though they don’t test on animals themselves,  because of requirements by law, their products or ingredients can be tested on animals in places like China.",
 "The U.S. Department of Labor said it found widespread “sweatshop-like” labor violations in downtown LA’s fashion district, resulting in the recovery of more than $326,200 in back wages for 185 employees. On average, workers were being paid less than $6.50 per hour, well below the California minimum wage of $8 per hour and the federal minimum wage of $7.25 per hour, according to the Labor Department. None of the employees received the overtime rate for overtime hours worked. Investigators also found that contractors were falsifying time cards and under-reporting or failing to maintain accurate records of employees’ hours.",
