...
var NameProvider = ["data","DATA","DATA","DATA","DATA","DATA","DATA","Other"];
	
var matrix = [
[9.6899,0.8859,0.0554,0.443,2.5471,2.4363,0.5537,2.5471], /*data 19.1584*/
[0.1107,1.8272,0,0.4983,1.1074,1.052,0.2215,0.4983], /*DATA 5.3154*/
[0.0554,0.2769,0.2215,0.2215,0.3876,0.8306,0.0554,0.3322], /*DATA 2.3811*/
[0.0554,0.1107,0.0554,1.2182,1.1628,0.6645,0.4983,1.052], /*DATA 4.8173*/
[0.2215,0.443,0,0.2769,10.4097,1.2182,0.4983,2.8239], /*DATA 15.8915*/
[1.1628,2.6024,0,1.3843,8.7486,16.8328,1.7165,5.5925], /*DATA 38.0399*/
[0.0554,0.4983,0,0.3322,0.443,0.8859,1.7719,0.443], /*DATA 4.4297*/
...
d3.select("#clicker")      
	.on("click", function(e){
		...
		//Show the chord between DATA and DATA
		...
		//Show all chords that are connected to data
		else if(counter == 11) Draw11();
		//All data are grey
		else if(counter == 12) Draw12();
		//data lost almost nobody
